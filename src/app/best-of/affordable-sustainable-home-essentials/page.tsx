      ...
      <main className="flex-grow">
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
                ...
                {prod.summary.map((s, i) => (
                  <div key={i} className="mb-3">
                    <div className="flex items-center gap-2 mb-1">
                      {s.icon === 'check' ? <CheckCircle className="w-5 h-5 text-orange-700" /> : <AlertTriangle className="w-5 h-5 text-amber-500" />}
          ...
          <section className="mb-16 bg-gradient-to-br from-orange-700 to-orange-900 rounded-2xl p-8 text-white">
            ...
            <p className="text-orange-100 text-sm pt-4 italic">Prices and ratings checked as of publication. Scores updated as new evidence becomes available.</p>
          </section>
