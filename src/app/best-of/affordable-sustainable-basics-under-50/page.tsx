      ...
      <header className="bg-white border-b sticky top-0 z-10 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8">
            ...
            <Link href="/best-of" className="text-green-700 font-bold hover:text-green-600">Best Of</Link>
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <nav className="text-sm text-gray-500 mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2">
              ...
              <li>/</li>
              <li><Link href="/best-of" className="hover:text-green-600">Best Of</Link></li>
              <li>/</li>
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 leading-tight">
            The Most Affordable Organic &amp; Sustainable Basics <span className="text-green-600">(Under $50)</span>
          </h1>
          ...
          <section className="mb-16 bg-white rounded-2xl border shadow-sm p-6 md:p-8">
            ...
            <p className="text-green-700 font-bold mb-6">Best for: Everyday organic cotton basics at mainstream prices</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-3">
                ...
                <div className="flex justify-between"><span className="text-gray-600">Observed low price:</span><span className="font-semibold text-green-700">~$25</span></div>
                ...
                <div className="flex justify-between"><span className="text-gray-600">Brand HSS:</span><span className="font-semibold"><span className="bg-green-600 text-white px-2 py-0.5 rounded text-sm">79/100</span> — Very Good</span></div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-50"><td className="p-3 border-b">Sale price (20–30% off)</td><td className="p-3 border-b">~$25–$32</td><td className="p-3 border-b text-green-700 font-semibold">~$0.25–$0.32</td></tr>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Climate Impact (82/100)</span></div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Pollution Prevention (78/100)</span></div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Supply Chain &amp; Social (85/100) ✅ Strongest pillar</span></div>
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-green-900 font-medium text-sm"><strong>👉 Verdict:</strong> Pact is the strongest entry point for shoppers looking for affordable sustainable clothing with real certifications behind it. For the price point, no other brand delivers this level of verified proof.</p>
              </div>
            </div>
          ...
          <section className="mb-16 bg-white rounded-2xl border shadow-sm p-6 md:p-8">
            ...
            <p className="text-green-700 font-bold mb-6">Best for: Budget-friendly sustainable underwear without compromise</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-3">
                ...
                <div className="flex justify-between"><span className="text-gray-600">Lowest per-pair:</span><span className="font-semibold text-green-700">~$8–$9 in 6-pack sale</span></div>
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="bg-green-50"><td className="p-3 border-b font-semibold text-green-900">Sale on 6-pack</td><td className="p-3 border-b">~$48–$55</td><td className="p-3 border-b font-semibold text-green-700">~$8.00–$9.17 🏆 Best value</td></tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-green-900 font-medium text-sm"><strong>👉 Verdict:</strong> At ~$10/pair or less, Pact&apos;s multipacks beat most conventional brands on both price and sustainability proof.</p>
              </div>
            </div>
          ...
          <section className="mb-16 bg-white rounded-2xl border shadow-sm p-6 md:p-8">
            ...
            <p className="text-green-700 font-bold mb-6">Best for: Maximum sustainability rigor when you can time the sale</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-3">
                ...
                <div className="flex justify-between"><span className="text-gray-600">Observed low price:</span><span className="font-semibold text-green-700">~$44</span></div>
                ...
                <div className="flex justify-between"><span className="text-gray-600">Brand HSS:</span><span className="font-semibold"><span className="bg-green-600 text-white px-2 py-0.5 rounded text-sm">95/100</span> — Excellent 🏆</span></div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-50"><td className="p-3 border-b font-semibold text-green-900">Patagonia Web Special</td><td className="p-3 border-b font-semibold text-green-700">~$44–$49</td><td className="p-3 border-b">Direct from Patagonia, limited sizes</td></tr>
                  ...
                  <tr className="bg-green-50"><td className="p-3 border-b font-semibold text-green-900">Secondhand / Worn Wear</td><td className="p-3 border-b font-semibold text-green-700">~$30–$45</td><td className="p-3 border-b">Certified used, lowest carbon option</td></tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Climate Impact (96/100)</span></div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Circular Economy (97/100) ✅ Best-in-class</span></div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Pollution Prevention (88/100)</span></div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Supply Chain &amp; Social (98/100) ✅ Gold standard</span></div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2"><CheckCircle className="w-5 h-5 text-green-600" /><span className="font-bold">Biodiversity &amp; Sourcing (94/100)</span></div>
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-green-900 font-medium text-sm"><strong>👉 Verdict:</strong> Patagonia is the most rigorously sustainable brand in this guide. At ~$44 on sale, the Baggies Shorts are the single best value for a shopper who prioritizes maximum sustainability proof.</p>
              </div>
            </div>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="bg-white">
                    ...
                    <td className="p-3 border-b text-green-700 font-semibold">~$25</td>
                    <td className="p-3 border-b"><span className="bg-green-600 text-white px-2 py-0.5 rounded text-xs">79/100</span></td>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="p-3 border-b text-green-700 font-semibold">~$12/pair</td>
                    <td className="p-3 border-b"><span className="bg-green-600 text-white px-2 py-0.5 rounded text-xs">79/100</span></td>
                  ...
                  <tr className="bg-white">
                    ...
                    <td className="p-3 border-b text-green-700 font-semibold">~$44</td>
                    <td className="p-3 border-b"><span className="bg-green-600 text-white px-2 py-0.5 rounded text-xs">95/100</span></td>
          ...
          {/* Final Verdict */}
          <section className="mb-16 bg-gradient-to-br from-green-600 to-green-800 rounded-2xl p-8 text-white">
            ...
            <div className="space-y-4 text-green-50">
              ...
              <p className="text-green-200 text-sm pt-4 italic">Hummlan will continue updating tracked prices and HSS scores as new certifications, disclosures, and deal patterns emerge. This is not a static guide — it&apos;s a living comparison.</p>
            </div>
          </section>

          {/* Publishing Meta */}
          <div className="text-sm text-gray-500 border-t pt-6">
            <p><strong>Internal links:</strong> <Link href="/best-of" className="text-green-600 hover:underline">Best Of hub</Link> · <Link href="/about" className="text-green-600 hover:underline">Our Methodology</Link> · <Link href="/shop" className="text-green-600 hover:underline">Shop</Link></p>
