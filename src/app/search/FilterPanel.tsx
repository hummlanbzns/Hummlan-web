    ...
    <div className="max-w-5xl mx-auto mb-6">
      <div className="bg-white border rounded-2xl p-4 shadow-sm">
        <div className="flex flex-wrap items-end gap-4">
          ...
          <div>
            <label className="text-xs font-bold text-gray-700 uppercase mb-1.5 block">Sort</label>
          ...
          <div>
            <label className="text-xs font-bold text-gray-700 uppercase mb-1.5 block">Min Score</label>
